...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for author_id in range(number_of_authors):
            Doctor.objects.create(first_name='Christian {0}'.format(author_id),
...
from catalog.models import Event, Client, Genre, Language
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        # Create a book
        test_author = Doctor.objects.create(first_name='John', last_name='Smith')
        test_genre = Genre.objects.create(name='Fantasy')
        test_language = Language.objects.create(name='English')
        test_book = Client.objects.create(
            title='Client Title',
        ...
        for book_copy in range(number_of_book_copies):
            ...
            status = 'm'
            Event.objects.create(book=test_book, imprint='Unlikely Imprint, 2016', due_back=return_date,
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        get_ten_books = Event.objects.all()[:10]
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_genre = Genre.objects.create(name='Fantasy')
        test_language = Language.objects.create(name='English')
        test_book = Client.objects.create(title='Client Title', summary='My book summary',
        ...
        # Create a Event object for test_user1
        return_date = datetime.date.today() + datetime.timedelta(days=5)
        self.test_bookinstance1 = Event.objects.create(book=test_book,
                                                       imprint='Unlikely Imprint, 2016', due_back=return_date,
                                                       borrower=test_user1, status='o')

        # Create a Event object for test_user2
        return_date = datetime.date.today() + datetime.timedelta(days=5)
        self.test_bookinstance2 = Event.objects.create(book=test_book, imprint='Unlikely Imprint, 2016',
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/catalog/doctor/create/')
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        # Manually check redirect because we don't know what doctor was created
        self.assertEqual(response.status_code, 302)
        self.assertTrue(response.url.startswith('/catalog/doctor/'))
